...
module org.mucommander.protocol.sftp {
    requires org.slf4j;
    ...
    exports com.mucommander.commons.file.protocol.sftp;

    // Provide protocol services
    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.sftp.SftpProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.sftp.SftpProtocolPanelProvider;
}
