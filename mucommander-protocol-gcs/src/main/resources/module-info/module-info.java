...
module org.mucommander.protocol.gcs {
    requires org.slf4j;
    ...
    exports com.mucommander.commons.file.protocol.gcs;

    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.gcs.GcsProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.gcs.GcsProtocolPanelProvider;
}
