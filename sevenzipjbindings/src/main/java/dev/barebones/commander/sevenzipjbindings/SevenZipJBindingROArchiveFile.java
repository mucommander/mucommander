...
package dev.barebones.commander.sevenzipjbindings;
...
import dev.barebones.commander.commons.file.archive.WrapperArchiveEntryIterator;
import dev.barebones.commander.commons.util.CircularByteBuffer;
import dev.barebones.commander.commons.util.StringUtils;
import dev.barebones.commander.sevenzipjbindings.multivolume.InArchiveWrapper;
import dev.barebones.commander.sevenzipjbindings.multivolume.SevenZipMultiVolumeCallbackHandler;
import dev.barebones.commander.sevenzipjbindings.multivolume.SevenZipRarMultiVolumeCallbackHandler;
...
public class SevenZipJBindingROArchiveFile extends AbstractROArchiveFile {
    ...
    /**
     * Creates and return an {@link ArchiveEntry()} whose attributes are fetched from the given {@link dev.barebones.commander.commons.file.impl.sevenzip.provider.SevenZip.Archive.SevenZipEntry}
     *
