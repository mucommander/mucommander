...
/**
 * JPMS service provider for vsphere protocol UI panel.
 *
 * @author Arik Hadas
 */
public class VSphereProtocolPanelProvider implements ProtocolPanelProvider {
