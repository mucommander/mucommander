...
open module org.mucommander.protocol.vsphere {
    requires org.slf4j;
    ...
    exports com.mucommander.commons.file.protocol.vsphere;

    // Provide protocol services
    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.vsphere.VSphereProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.vsphere.VSphereProtocolPanelProvider;
}
