...
public abstract class AutocompleterTextComponent {
    ...
    public boolean isShowing() {
        return textComponent.isShowing();
    }
    ...
    public Rectangle modelToView() throws BadLocationException {
        return textComponent.getUI().modelToView(textComponent, textComponent.getCaretPosition());
    }
    ...
    public boolean isCarentAtEndOfTextAtInsertion() {
        return textComponent.getCaretPosition() == textComponent.getText().length() - 1;
    }
    ...
    public void addKeyListener(KeyAdapter adapter) {
        textComponent.addKeyListener(adapter);
    }

    public void addFocusListener(FocusListener listener) {
        textComponent.addFocusListener(listener);
    }
