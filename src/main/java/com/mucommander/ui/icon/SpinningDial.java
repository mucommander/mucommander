...
public class SpinningDial extends AnimatedIcon {
    ...
    public SpinningDial(boolean animate) {
        this(DEFAULT_SIZE, DEFAULT_SIZE, animate);
    }
     ...
     */
    public SpinningDial(Color c) {
        this(DEFAULT_SIZE, DEFAULT_SIZE, c);
    }
     ...
     * @param animate whether to animate the dial immediately or not.
     */
    public SpinningDial(Color c, boolean animate) {
        this(DEFAULT_SIZE, DEFAULT_SIZE, c, animate);
    }
    ...
    public SpinningDial(int w, int h, boolean animate) {
        this(w, h, DEFAULT_SPOKES, animate);
    }
     ...
     * @param c color in which to paint the dial.
     */
    public SpinningDial(int w, int h, Color c) {
        this(w, h, DEFAULT_SPOKES, c);
    }
     ...
     * @param animate whether to animate the dial immediately or not.
     */
    public SpinningDial(int w, int h, Color c, boolean animate) {
        this(w, h, DEFAULT_SPOKES, c, animate);
    }
    ...
    public SpinningDial(int w, int h, int spokes, Color c) {
        this(w, h, spokes, c, DEFAULT_ANIMATE);
    }
     ...
     */
    public synchronized void setStrokeWidth(float width) {
        strokeWidth = width;
    }
    ...
    protected Color getSpokeColor(int alpha) {
        return new Color(color.getRed(), color.getGreen(), color.getBlue(), Math.max(MIN_ALPHA, alpha));
    }
