        ...
        try {
            ...
            try {
                ...
                if (!wasUserThemeLoaded) {
                    try {
                        currentTheme = readTheme(Theme.USER_THEME, null);
                    } catch (Exception e3) {
                    }
                }
...
//        catch(IOException e) {return Collections.emptyList().iterator();}
    ...
    public static Vector<Theme> getAvailableThemes() {
        ...
        try {
            themes.add(readTheme(Theme.USER_THEME, null));
        } catch (Exception e) {
        ...
        while (iterator.hasNext()) {
            name = iterator.next();
            try {
                themes.add(readTheme(Theme.PREDEFINED_THEME, name));
            } catch (Exception e) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                name = iterator.next();
                try {
                    themes.add(readTheme(Theme.CUSTOM_THEME, name));
                } catch (Exception e) {
     ...
     */
    public static void setUserThemeFile(File file) throws FileNotFoundException {
    ...
    public static void writeThemeData(ThemeData data, File file) throws IOException {
        ...
        try {
            writeThemeData(data, out = new FileOutputStream(file));
        }
    ...
    public static void writeTheme(Theme theme) throws IOException {
        writeTheme(theme, theme.getType(), theme.getName());
    }
    ...
    public static void exportTheme(int type, String name, OutputStream out) throws IOException {
        ...
        in = null;
        try {
            StreamUtils.copyStream(in = getInputStream(type, name), out);
        } finally {
            if (in != null) {
                try {
                    in.close();
    ...
    public static void exportTheme(int type, String name, File file) throws IOException {
        ...
        out = null;
        try {
            exportTheme(type, name, out = new FileOutputStream(file));
        } finally {
            if (out != null) {
                try {
                    out.close();
     ...
     * @throws IOException if any I/O related error occurs.
     */
    public static void exportTheme(Theme theme, OutputStream out) throws IOException {
    ...
    public static Theme importTheme(File file) throws IOException, Exception {
        ...
        // Imports the theme.
        try {
            StreamUtils.copyStream(in = new FileInputStream(file), out = getCustomThemeOutputStream(name));
        }
    ...
    public static Theme readTheme(int type, String name) throws Exception {
        ...
        in = null;
        try {
            data = readThemeData(in = getInputStream(type, name));
        } finally {
            if (in != null) {
                try {
                    in.close();
    ...
    public static ThemeData readThemeData(File file) throws Exception {
        ...
        try {
            return readThemeData(in = new FileInputStream(file));
        }
    ...
    private static void setConfigurationTheme(Theme theme) {
        setConfigurationTheme(theme.getType(), theme.getName());
    }
