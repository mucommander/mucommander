...
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.Archive;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.Volume;
...
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.io.ReadOnlyAccessInputStream;
...
public class ComprDataIO {
	...
	public void init(OutputStream outputStream) {
		if (outputStream == null) {
			testMode = true; //Until it will be initiated with OutputStream
		}
		else {
    ...
    public void init(FileHeader hd, InputStream in) throws IOException {
