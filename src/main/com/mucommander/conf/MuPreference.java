...
public enum MuPreference {
	...
	LEFT_STARTUP_FOLDER(MuPreferences.LEFT_STARTUP_FOLDER),
	RIGHT_STARTUP_FOLDER(MuPreferences.RIGHT_STARTUP_FOLDER),
	LINE_WRAP(MuPreferences.LINE_WRAP),
	LINE_NUMBERS(MuPreferences.LINE_NUMBERS),
