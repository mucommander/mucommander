...
public class MainMenuBar extends JMenuBar implements ActionListener, MenuListener {
    ...
    public void menuSelected(MenuEvent e) {
        ...
        if(source==viewMenu) {
            ...
            toggleShowHiddenFilesItem.setSelected(MuConfigurations.getPreferences().getVariable(MuPreferences.SHOW_HIDDEN_FILES, MuPreferences.DEFAULT_SHOW_HIDDEN_FILES));
