...
import dev.barebones.commander.commons.conf.ValueList;
...
/**
 * muCommander specific wrapper for the <code>dev.barebones.commander.conf</code> API which is used to save 'static' configurations.
...
public class MuPreferences implements MuPreferencesAPI {
    ...
    /** Default setting for whether to show keyboard shortcut hints */
