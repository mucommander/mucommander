...
public class NFSFile extends ProtocolFile {
    ...
    /**
     * <b>Warning:</b> the returned {@link dev.barebones.commander.commons.file.protocol.nfs.NFSFile.NFSRandomAccessOutputStream} instance
     * is not fully functional, its {@link dev.barebones.commander.commons.file.protocol.nfs.NFSFile.NFSRandomAccessOutputStream#setLength(long)}
