...
import dev.barebones.commander.commons.io.bom.BOMWriter;
    ...
    public TextEditor(boolean fromSearchWithContent) {
        textViewerDelegate = new TextViewer(textEditorImpl = new TextEditorImpl(true, fromSearchWithContent)) {
            ...
            protected void initMenuBarItems() { // TODO code dup with TextViewer, fix it
                ...
                findItem = MenuToolkit.addMenuItem(editMenu, Translator.get("text_editor.find_and_replace"), menuItemMnemonicHelper, DesktopManager.getActionShortcuts().getDefaultKeystroke(ActionType.Find), listener);
