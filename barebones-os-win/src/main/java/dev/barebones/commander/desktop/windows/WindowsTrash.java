...
import dev.barebones.commander.commons.file.util.Shell32API;
 ...
 * invoking those methods (via JNA), so for performance reasons, this trash is implemented as a {@link dev.barebones.commander.desktop.QueuedTrash}
 * in order to group calls to {@link #moveToTrash(dev.barebones.commander.commons.file.AbstractFile)}.</p>
 *
