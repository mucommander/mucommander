...
module org.mucommander.protocol.s3 {
    requires org.slf4j;
    ...
    exports com.mucommander.commons.file.protocol.s3;

    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.s3.S3ProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.s3.S3ProtocolPanelProvider;
}
