...
# barebones-commander startup arguments
BAREBONES_ARGS="@ARGS@"
JAVA_ARGS="@JAVA_ARGS@"
...
$JAVA --add-opens java.desktop/javax.swing.plaf.basic=ALL-UNNAMED \
      ...
      $EXTRA_OPTIONS \
      -Djava.library.path=/usr/local/lib -cp barebones-commander-@MU_VERSION@.jar dev.barebones.commander.main.muCommander "$@"
