...
module org.mucommander.protocol.http {
    requires org.slf4j;
    ...
    exports com.mucommander.commons.file.protocol.http;

    // Provide protocol services
    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.http.HttpProtocolServiceProvider,
             com.mucommander.commons.file.protocol.http.HttpsProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.http.HttpProtocolPanelProvider;
}
