...
//        // 0s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format(0));
//        // 1s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format(1000));
//        // 1m 1s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format(61*1000));
//        // 1h 1m 1s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format(3661*1000));
//        // 1d 1h 1m 1s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format(90061*1000));
//        // 1m 1h 1m 1s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format((2592000+90061)*(long)1000));
//        // 1y 1m 1h 1m 1s
//        System.out.println(dev.barebones.commander.text.DurationFormat.format((31104000+2592000+90061)*(long)1000));
//        // Infinite
//        System.out.println(dev.barebones.commander.text.DurationFormat.format(1001l*Integer.MAX_VALUE));
//    }
}
