 ...
 * <p>
 * This class is meant for use with {@link dev.barebones.commander.commons.util.xml.XmlWriter}. It's used to hold a list of XML attributes
 * that will be passed to one of the {@link dev.barebones.commander.commons.util.xml.XmlWriter#startElement(String,XmlAttributes) element
 * opening} methods.
 * </p>
 * 
