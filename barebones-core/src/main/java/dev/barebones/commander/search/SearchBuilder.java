...
package dev.barebones.commander.search;
...
import dev.barebones.commander.job.impl.SearchJob;
 ...
 * @author Arik Hadas
 */
public class SearchBuilder implements dev.barebones.commander.commons.file.protocol.search.SearchBuilder {
