 ...
 *       ({@link dev.barebones.commander.RuntimeConstants#BUILD_NUMBER})</li>
 ...
 *       ({@link dev.barebones.commander.RuntimeConstants#BUILD_DATE})</li>
...
public class VersionChecker {
    ...
    /**
     * Checks if the current build is a nightly build based on the {@link dev.barebones.commander.RuntimeConstants#BUILD_NUMBER).
     *
