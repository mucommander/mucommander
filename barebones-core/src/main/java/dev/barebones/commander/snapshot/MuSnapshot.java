...
package dev.barebones.commander.snapshot;
...
import dev.barebones.commander.commons.conf.Configuration;
import dev.barebones.commander.commons.conf.ConfigurationException;
import dev.barebones.commander.commons.conf.XmlConfigurationReader;
import dev.barebones.commander.commons.conf.XmlConfigurationWriter;
import dev.barebones.commander.commons.file.FileURL;
import dev.barebones.commander.conf.MuSnapshotFile;
...
/**
 * muCommander specific wrapper for the <code>dev.barebones.commander.conf</code> API which is used to save 'dynamic' configurations.
...
public class MuSnapshot {
	...
	/**
	 * Returns the section of the {@link dev.barebones.commander.ui.main.MainFrame} at a given index
	 * 
	...
	/**
	 * Returns the section of the properties for the {@link dev.barebones.commander.ui.main.MainFrame} at a given index
	 * 
	...
	/**
	 * Returns the horizontal position on the screen of the {@link dev.barebones.commander.ui.main.MainFrame} at a given index
	 * 
	 * @param window index of MainFrame
	...
	/**
	 * Return the vertical position on the screen of the {@link dev.barebones.commander.ui.main.MainFrame} at a given index
	 * 
	 * @param window index of MainFrame
    ...
    /**
     * Returns the width of the {@link dev.barebones.commander.ui.main.MainFrame} at a given index
     * 
     * @param window index of MainFrame
    ...
    /**
     * Return the height of the {@link dev.barebones.commander.ui.main.MainFrame} in a given index
     * 
     * @param window index of MainFrame
    ...
    /**
     * Returns the orientation used to split folder panels in the {@link dev.barebones.commander.ui.main.MainFrame} at a given index
     * 
     * @param window index of MainFrame
	...
	/**
     * Returns the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.ui.main.FolderPanel},
     * left or right one in the {@link dev.barebones.commander.ui.main.MainFrame} at the given index.
     *
     * @param window index of MainFrame
	...
	/**
     * Returns the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.ui.main.tree.FoldersTreePanel},
     * left or right one in the {@link dev.barebones.commander.ui.main.MainFrame} at the given index.
     *
     * @param window index of MainFrame
     ...
     * {@link dev.barebones.commander.ui.main.FolderPanel} at the {@link dev.barebones.commander.ui.main.MainFrame} in the given index.
     *
     * @param window index of MainFrame
     * @param left true for the left FolderPanel, false for the right one
    ...
    /**
     * Returns the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.ui.main.table.FileTable},
     * left or right one in the {@link dev.barebones.commander.ui.main.MainFrame} at the given index.
     *
     * @param window index of MainFrame
    ...
    /**
     * Returns the CONFIGURATION section that describes the sorting of the specified {@link dev.barebones.commander.ui.main.table.FileTable},
     * left or right one in the {@link dev.barebones.commander.ui.main.MainFrame} at the given index.
     * 
     * @param window index of MainFrame
     * @param left true for the left FileTable, false for the right one
     ...
     * in the left or right {@link dev.barebones.commander.ui.main.FolderPanel} at the {@link dev.barebones.commander.ui.main.MainFrame} in the given index.
     *
     * @param window index of MainFrame
     * @param left true for the left FolderPanel, false for the right one
     ...
     * {@link dev.barebones.commander.ui.main.table.FileTable} at the {@link dev.barebones.commander.ui.main.MainFrame} in the given index.
     *
     * @param window index of MainFrame
     * @param column column, see {@link dev.barebones.commander.ui.main.table.Column} for possible values
     * @param left true for the left FileTable, false for the right one
     * @return the CONFIGURATION section corresponding to the specified FileTable
     */
    ...
    /**
     * Returns the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.ui.main.tabs.FileTableTabs},
     * left or right one in the {@link dev.barebones.commander.ui.main.MainFrame} at the given index.
     *
     * @param window index of MainFrame
    ...
    /**
     * Returns the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.ui.main.tabs.FileTableTab},
     * left or right one in the {@link dev.barebones.commander.ui.main.MainFrame} at the given index.
     *
     * @param window index of MainFrame
     * @param left true for the left FileTableTab, false for the right one
    ...
    /**
     * Returns the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.core.GlobalLocationHistory}

     * @return the CONFIGURATION section corresponding to the specified {@link dev.barebones.commander.core.GlobalLocationHistory}
     */    
