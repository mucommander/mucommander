...
import dev.barebones.commander.desktop.ActionShortcuts;
...
import dev.barebones.commander.desktop.DesktopOperation;
...
public final class DesktopManager {
    ...
    // -------------------------------------------------------------------
    /**
     * Returns an instance of the {@link dev.barebones.commander.desktop.AbstractTrash} implementation that can be used on the current platform.
    ...
    /**
     * Returns the object used to create instances of {@link dev.barebones.commander.desktop.AbstractTrash}.
    ...
    /**
     * Sets the object that is used to create instances of {@link dev.barebones.commander.desktop.AbstractTrash}.
     * @param provider object that will be used to create instances of {@link dev.barebones.commander.desktop.AbstractTrash}.
     */
