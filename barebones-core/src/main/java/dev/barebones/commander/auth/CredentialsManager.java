...
import dev.barebones.commander.commons.collections.VectorChangeListener;
import dev.barebones.commander.commons.file.AbstractFile;
import dev.barebones.commander.commons.file.Authenticator;
...
public class CredentialsManager {
     ...
     * URL by calling {@link #authenticate(dev.barebones.commander.commons.file.FileURL, CredentialsMapping)}.
     * Returns <code>true</code> if a set of credentials was found and used to authenticate the URL, <code>false</code>
     * otherwise.
     *
     * <p>Credentials are first looked for using {@link #getMatchingCredentials(dev.barebones.commander.commons.file.FileURL)}.
