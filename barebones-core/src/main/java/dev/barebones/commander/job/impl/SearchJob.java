...
import dev.barebones.commander.commons.file.protocol.search.SearchListener;
 ...
 * @author Arik Hadas
 */
public class SearchJob extends FileJob implements dev.barebones.commander.commons.file.protocol.search.SearchJob {
