...
package dev.barebones.commander.job;
 ...
 * <li>{@link #SOURCE_PARENT_OF_DESTINATION}: source is a folder (as returned by {@link dev.barebones.commander.commons.file.AbstractFile#isBrowsable()}
 * and a parent of destination.
 * </ul>
 *
 * <p>The value returned by {@link #checkForCollision(dev.barebones.commander.commons.file.AbstractFile, dev.barebones.commander.commons.file.AbstractFile)}
 * can be used to create a {@link dev.barebones.commander.ui.dialog.file.FileCollisionDialog} in order to inform the user of the collision
 * and ask him how to resolve it.
 *
 * @see dev.barebones.commander.ui.dialog.file.FileCollisionDialog
