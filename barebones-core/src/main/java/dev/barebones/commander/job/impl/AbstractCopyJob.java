...
import dev.barebones.commander.ui.dialog.file.FileCollisionRenameDialog;
...
/**
 * This class is the parent class of {@link dev.barebones.commander.job.impl.CopyJob} and {@link dev.barebones.commander.job.impl.MoveJob} and
 * allows them to share methods and fields.
 *
 * @author Maxence Bernard, Mariusz Jakubowski
 * @see dev.barebones.commander.job.impl.CopyJob
 * @see dev.barebones.commander.job.impl.MoveJob
 */
