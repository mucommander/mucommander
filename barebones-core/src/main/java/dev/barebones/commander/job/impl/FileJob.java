...
import dev.barebones.commander.job.FileJobListener;
import dev.barebones.commander.job.FileJobState;
import dev.barebones.commander.job.JobProgress;
import dev.barebones.commander.job.JobsManager;
import dev.barebones.commander.job.ui.DialogResult;
import dev.barebones.commander.job.ui.UserInputHelper;
import dev.barebones.commander.os.notifier.NotificationType;
 ...
 */
public abstract class FileJob implements dev.barebones.commander.job.FileJob {
