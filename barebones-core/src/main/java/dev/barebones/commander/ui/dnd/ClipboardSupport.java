...
public class ClipboardSupport {
    ...
    /**
     * Returns the files contained by the system clipboard as a {@link dev.barebones.commander.commons.file.util.FileSet}, <code>null</code>
    ...
    /**
     * Transfers the files contained in the specified {@link dev.barebones.commander.commons.file.util.FileSet} to the system clipboard.
