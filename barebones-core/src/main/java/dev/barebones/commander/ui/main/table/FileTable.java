...
import dev.barebones.commander.ui.action.impl.MarkSelectedFileAction;
import dev.barebones.commander.ui.action.impl.RefreshAction;
import dev.barebones.commander.ui.dialog.file.AbstractCopyDialog;
import dev.barebones.commander.ui.dialog.file.FileCollisionDialog;
import dev.barebones.commander.ui.event.ActivePanelListener;
import dev.barebones.commander.ui.event.TableSelectionListener;
...
import dev.barebones.commander.ui.main.menu.TablePopupMenu;
import dev.barebones.commander.ui.quicksearch.QuickSearch;
import dev.barebones.commander.ui.theme.ColorChangedEvent;
import dev.barebones.commander.ui.theme.FontChangedEvent;
import dev.barebones.commander.ui.theme.Theme;
import dev.barebones.commander.ui.theme.ThemeListener;
...
public class FileTable extends JTable implements MouseListener, MouseMotionListener, KeyListener,
     ...
     * @see dev.barebones.commander.ui.main.MainFrame#getActiveTable()
     */
    ...
    /**
     * Returns the file that is currently selected (highlighted), wrapped in a {@link dev.barebones.commander.commons.file.CachedFile}
     ...
     * and notifies registered {@link dev.barebones.commander.ui.event.TableSelectionListener} that the files currently marked
     ...
     * and notifies registered {@link dev.barebones.commander.ui.event.TableSelectionListener} that currently marked files
     ...
     *
     * @param criterion the sort criterion, see {@link dev.barebones.commander.ui.main.table.Column} for possible values
...
//            return false;
     ...
     * and fire a {@link dev.barebones.commander.ui.event.TableSelectionListener#selectedFileChanged(FileTable)} event
