...
import dev.barebones.commander.ui.dialog.auth.AuthDialog;
...
public class ConfFileTableTab extends FileTableTab {
	 ...
	 * @param folderPanelType identifier of the panel we want to compute the path for (either {@link dev.barebones.commander.ui.main.FolderPanel.FolderPanelType.LEFT} or
