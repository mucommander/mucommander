...
import dev.barebones.commander.ui.action.impl.*;
 ...
 * {@link dev.barebones.commander.ui.main.MainFrame} saves some memory and also CPU cycles as some actions listen to particular events to change
...
public class ActionManager {
     ...
     * and associated with the given {@link dev.barebones.commander.ui.main.MainFrame} and calls {@link MuAction#performAction()} on it.
     * Returns <code>true</code> if an instance of the action could be retrieved and performed, <code>false</code>
     * if the MuAction could not be found or could not be instantiated.
     *
