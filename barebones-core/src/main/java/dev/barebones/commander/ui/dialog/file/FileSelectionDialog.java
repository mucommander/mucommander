...
import dev.barebones.commander.commons.file.filter.ContainsFilenameFilter;
import dev.barebones.commander.commons.file.filter.EndsWithFilenameFilter;
import dev.barebones.commander.commons.file.filter.EqualsFilenameFilter;
import dev.barebones.commander.commons.file.filter.FileFilter;
import dev.barebones.commander.commons.file.filter.PassThroughFileFilter;
import dev.barebones.commander.commons.file.filter.RegexpFilenameFilter;
import dev.barebones.commander.commons.file.filter.StartsWithFilenameFilter;
...
public class FileSelectionDialog extends FocusDialog implements ActionListener {
    ...
    public FileSelectionDialog(MainFrame mainFrame, boolean addToSelection) {
        ...
        super(mainFrame.getJFrame(), Translator.get(addToSelection?"file_selection_dialog.mark":"file_selection_dialog.unmark"), mainFrame.getJFrame());
