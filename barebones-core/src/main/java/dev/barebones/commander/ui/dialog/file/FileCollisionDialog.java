...
import dev.barebones.commander.commons.util.ui.text.FontUtils;
...
import dev.barebones.commander.ui.text.FileLabel;


/**
 * Dialog used to inform the user that a file collision has been detected and ask him how to resolve the conflict.
 * Prior to invoking this dialog, {@link dev.barebones.commander.job.FileCollisionChecker} can be used to check for file collisions.
 *
 * @author Maxence Bernard
 * @see dev.barebones.commander.job.FileCollisionChecker
 */
public class FileCollisionDialog extends QuestionDialog {
     ...
     * @param collisionType     the type of collision as returned by {@link dev.barebones.commander.job.FileCollisionChecker}
