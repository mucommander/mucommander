 ...
 *
 * <p>Optionally, a FileFilter can be specified using {@link #setSelectedFileFilter(dev.barebones.commander.commons.file.filter.FileFilter) setSelectedFileFilter}
...
public abstract class SelectedFileAction extends FileAction {
    ...
    protected boolean getFileTableCondition(FileTable fileTable) {
        ...
        return filter == null || filter.match(selectedFile);
    }
}
