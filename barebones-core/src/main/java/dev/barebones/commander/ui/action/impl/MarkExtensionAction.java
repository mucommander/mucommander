...
import dev.barebones.commander.commons.file.filter.AbstractFilenameFilter;
...
public class MarkExtensionAction extends MuAction {
    ...
    // -----------------------------------------------------------------------------------
    /**
     * Creates a {@link dev.barebones.commander.commons.file.filter.FilenameFilter} that should be applied to all current files.
     * <p>
