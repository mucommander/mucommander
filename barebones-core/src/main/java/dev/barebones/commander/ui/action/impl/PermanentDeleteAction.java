 ...
 * active folder. Unlike {@link dev.barebones.commander.ui.action.impl.DeleteAction}, the system trash is not used, files are
 * permanently deleted.
 *
 * @see dev.barebones.commander.ui.action.impl.DeleteAction
