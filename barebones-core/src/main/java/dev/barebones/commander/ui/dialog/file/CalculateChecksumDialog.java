...
import dev.barebones.commander.job.impl.CalculateChecksumJob;
import dev.barebones.commander.text.Translator;
import dev.barebones.commander.ui.action.ActionProperties;
import dev.barebones.commander.ui.action.impl.CalculateChecksumAction;
import dev.barebones.commander.ui.main.MainFrame;
import dev.barebones.commander.ui.text.FilePathField;

/**
 * This dialog prepares a {@link dev.barebones.commander.job.impl.CalculateChecksumJob} and lets the user choose a checksum
...
public class CalculateChecksumDialog extends JobDialog implements ActionListener, ItemListener {
    ...
    public CalculateChecksumDialog(MainFrame mainFrame, FileSet files) {
        super(mainFrame, ActionProperties.getActionLabel(ActionType.CalculateChecksum), files);
