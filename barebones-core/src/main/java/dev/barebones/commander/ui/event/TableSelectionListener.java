...
package dev.barebones.commander.ui.event;
 ...
 * {@link dev.barebones.commander.ui.main.table.FileTable#addTableSelectionListener(TableSelectionListener) FileTable.addTableSelectionListener()}.
 *
 * @see dev.barebones.commander.ui.main.table.FileTable
...
public interface TableSelectionListener {
     ...
     *
     * @param source the {@link dev.barebones.commander.ui.main.table.FileTable} instance on which the file selection has changed
     */
     ...
     *
     * @param source the {@link dev.barebones.commander.ui.main.table.FileTable} instance on which the files marked have changed
     */
