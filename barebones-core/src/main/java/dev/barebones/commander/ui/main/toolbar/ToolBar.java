...
package dev.barebones.commander.ui.main.toolbar;
...
import dev.barebones.commander.ui.action.impl.GoBackAction;
import dev.barebones.commander.ui.action.impl.GoForwardAction;
import dev.barebones.commander.ui.action.impl.OpenLocationAction;
import dev.barebones.commander.ui.button.NonFocusableButton;
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(source == this) {
            if (DesktopManager.isRightMouseButton(e)) {
                ...
                popupMenu.add(ActionManager.getActionInstance(ActionType.ToggleToolBar, mainFrame));
