...
package dev.barebones.commander.ui.main.frame;
...
import dev.barebones.commander.conf.MuPreferencesAPI;
import dev.barebones.commander.snapshot.MuSnapshot;
import dev.barebones.commander.ui.main.FolderPanel.FolderPanelType;
...
public abstract class MainFrameBuilder {
     ...
     * of a leap of faith.
     * </p>
     * @param  folderPanelType panel for which the initial path should be returned (either {@link dev.barebones.commander.ui.main.FolderPanel.FolderPanelType.LEFT} or
     *               {@link #@link dev.barebones.commander.ui.main.FolderPanel.FolderPanelType.RIGHT}).
