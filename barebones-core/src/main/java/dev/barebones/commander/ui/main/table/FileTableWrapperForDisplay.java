...
public class FileTableWrapperForDisplay extends JScrollPane implements FocusListener, ThemeListener {
	...
	/**
     * Dims the scrollpane's background, called by {@link dev.barebones.commander.ui.main.table.FileTable.QuickSearch} when a quick search is started.
     */
     ...
     * {@link dev.barebones.commander.ui.main.table.FileTable.QuickSearch} when a quick search is over.
     */
