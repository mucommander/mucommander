...
import dev.barebones.commander.commons.file.CachedFile;
...
public class FileTableModel extends AbstractTableModel {
    ...
    /**
     * Sets the {@link dev.barebones.commander.ui.main.table.SortInfo} instance that describes how the associated table is
     * sorted.
     *
    ...
    /**
     * Returns the current folder, i.e. the last folder set using {@link #setCurrentFolder(dev.barebones.commander.commons.file.AbstractFile, dev.barebones.commander.commons.file.AbstractFile[])}.
     *
    ...
    /**
     * Returns the date of the current folder, when it was set using {@link #setCurrentFolder(dev.barebones.commander.commons.file.AbstractFile, dev.barebones.commander.commons.file.AbstractFile[])}.
    ...
    /**
     * Returns a {@link dev.barebones.commander.commons.file.util.FileSet FileSet} with all currently marked files.
     * <p>
