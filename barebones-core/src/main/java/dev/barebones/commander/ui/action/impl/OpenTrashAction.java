 ...
 * current platform has an {@link dev.barebones.commander.desktop.AbstractTrash} implementation and if it is capable of opening
 * the trash, as reported by {@link dev.barebones.commander.desktop.AbstractTrash#canOpen()}.
 *
