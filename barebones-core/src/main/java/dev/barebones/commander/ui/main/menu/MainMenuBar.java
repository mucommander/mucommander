...
import dev.barebones.commander.ui.action.ActionParameters;
import dev.barebones.commander.ui.action.MuAction;
import dev.barebones.commander.ui.action.impl.OpenLocationAction;
import dev.barebones.commander.ui.action.impl.RecallWindowAction;
...
import dev.barebones.commander.ui.viewer.FileFrame;
...
public class MainMenuBar extends JMenuBar implements ActionListener, MenuListener {
    ...
    public MainMenuBar(MainFrame mainFrame) {
        ...
        MenuToolkit.addMenuItem(fileMenu, ActionManager.getActionInstance(ActionType.ToggleTerminal, mainFrame), menuItemMnemonicHelper);
