...
package dev.barebones.commander.ui.dnd;
 ...
 * <ul>
 *   <li>FileSetDataFlavor (as returned by {@link #getFileSetDataFlavor()}): data returned as a {@link dev.barebones.commander.commons.file.util.FileSet}.
...
public class TransferableFileSet implements Transferable {
    ...
    /**
     * Returns the files contained by the specified Transferable as a {@link dev.barebones.commander.commons.file.util.FileSet},
