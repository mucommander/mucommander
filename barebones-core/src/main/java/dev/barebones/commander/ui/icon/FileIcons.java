...
package dev.barebones.commander.ui.icon;
...
import dev.barebones.commander.commons.file.icon.FileIconProvider;
...
public class FileIcons {
    ...
    /**
     * Shorthand for {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)} called with the
    ...
    private static boolean shouldUseSystemIconFor(AbstractFile file) {
        ...
        case APPLICATIONS_ONLY:
            return dev.barebones.commander.core.desktop.DesktopManager.isApplication(file);
        case FOLDERS_ONLY:
    ...
    /**
     * Shorthand for {@link #getCustomFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)} called with the
     * icon dimension returned by {@link #getIconDimension()}.
     *
    ...
    /**
     * Shorthand for {@link #getSystemFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)} called with the
     * icon dimension returned by {@link #getIconDimension()}.
     *
     * @param file the file for which an icon is to be returned
     ...
     * underlying OS/desktop manager, using the {@link dev.barebones.commander.commons.file.icon.FileIconProvider} currently set.
    ...
    /**
     * Returns the {@link dev.barebones.commander.commons.file.icon.FileIconProvider} instance that provides 'custom' file icons.
     *
    ...
    /**
     * Sets the {@link dev.barebones.commander.commons.file.icon.FileIconProvider} instance that provides 'custom' file icons.
     *
    ...
    /**
     * Returns the {@link dev.barebones.commander.commons.file.icon.FileIconProvider} instance that provides 'system' file icons.
     *
     * @return the FileIconProvider instance that provides 'custom' file icons.
     */
     ...
     * the OS's default file manager. If <code>false</code> is returned and {@link #getSystemFileIcon(dev.barebones.commander.commons.file.AbstractFile)}
     * is used or {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile)} together with a system policy different from
