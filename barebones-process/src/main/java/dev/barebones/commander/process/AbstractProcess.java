 ...
 * instantiated through {@link dev.barebones.commander.process.ProcessRunner#execute(String[], dev.barebones.commander.commons.file.AbstractFile,ProcessListener)}.
 * </p>
