...
/**
 * JPMS service provider for registry protocol UI panel.
 *
 * @author Daniel Erez
 */
public class RegistryProtocolPanelProvider implements ProtocolPanelProvider {
