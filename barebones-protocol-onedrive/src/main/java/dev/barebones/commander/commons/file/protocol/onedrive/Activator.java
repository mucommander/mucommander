 ...
 */
package dev.barebones.commander.commons.file.protocol.onedrive;
    ...
    public void start(BundleContext context) throws Exception {
        FileProtocolService service = new FileProtocolService() {
            ...
            public ProtocolProvider getProtocolProvider() {
                return new OneDriveProtocolProvider();
            }
            ...
            public SchemeHandler getSchemeHandler() {
                return new DefaultSchemeHandler(new DefaultSchemeParser(),
                        ...
                        new Credentials("anonymous", "anonymous_coward@mucommander.com"));
            }
        };
        ProtocolPanelProvider panelProvider = new ProtocolPanelProvider() {
            ...
            public ServerPanel get(ServerPanelListener listener, JFrame mainFrame) {
                return new OneDrivePanel(listener, mainFrame);
            }
