 ...
 * <p>
 * This class can contain basic error information from either the <code>dev.barebones.commander.commons.conf</code> API
 * or the application. Application writers can subclass it to provide additional functionality. Different
 * classes of the <code>dev.barebones.commander.commons.conf</code> API may throw this exception or any exception subclassed
 * from it.
 * </p>
 * <p>
