 ...
 * While the <code>dev.barebones.commander.commons.conf</code> really only handles one type of variables, strings, it offers
 ...
 * we suggest creating a source using the <code>dev.barebones.commander.file</code> API.
 * </p>
 * <p>
