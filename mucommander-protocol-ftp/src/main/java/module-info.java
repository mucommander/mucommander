...
module org.mucommander.protocol.ftp {
    requires org.slf4j;
    ...
    exports com.mucommander.commons.file.protocol.ftp;

    // Provide protocol services
    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.ftp.FtpProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.ftp.FtpProtocolPanelProvider;
}
