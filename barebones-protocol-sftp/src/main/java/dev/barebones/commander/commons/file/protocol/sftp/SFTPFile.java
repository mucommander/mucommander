...
import dev.barebones.commander.commons.file.SyncedFileAttributes;
...
import dev.barebones.commander.commons.io.ByteUtils;
...
public class SFTPFile extends ProtocolFile {
     ...
     * See {@link dev.barebones.commander.commons.file.protocol.sftp.SFTPFile.SFTPFileAttributes} for more information.
     */
    @Override
    ...
    /**
     * Returns a {@link dev.barebones.commander.commons.file.protocol.sftp.SFTPFile.SFTPFileAttributes} instance corresponding to this file.
     */
    @Override
