 ...
 * The <code>dev.barebones.commander.commons.runtime</code> package provides helpful classes for this,
 * but application developers might end up having to try to run commands to see if they work
 * (this can be done through the {@link dev.barebones.commander.process.ProcessRunner} class), query
 ...
 * {@link dev.barebones.commander.command.Command commands},
 * {@link dev.barebones.commander.command.CommandManager#registerDefaultAssociation(String, FileFilter) associations}...<br>
 * </p>
...
public interface DesktopAdapter {
     ...
     * default {@link dev.barebones.commander.command.Command} and {@link dev.barebones.commander.ui.action.MuAction} registration, 
     * trash management...
     * </p>
     * <p>
     ...
     * dependant things such as {@link dev.barebones.commander.bookmark.Bookmark} or {@link dev.barebones.commander.ui.action.ActionKeymap}.
     * </p>
    ...
    default TrashProvider getTrash() { return null; }
    default AbstractNotifier getNotifier() { return null; }
