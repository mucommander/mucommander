 ...
 * </p>
 * <p>
 * At the time of writing, the API uses two different types of operations: {@link dev.barebones.commander.core.desktop.DesktopManager#BROWSE URL browsing}
 *  and {@link dev.barebones.commander.core.desktop.DesktopManager#OPEN local file opening}.
 ...
 * or {@link dev.barebones.commander.commons.file.protocol.local.LocalFile} parameter.
 * </p>
 * <p>
...
public interface DesktopOperation {
     ...
     * </p>
     * <p>
     * For example, a {@link dev.barebones.commander.core.desktop.DesktopManager#OPEN} operation that only accept XML files will return:
     * <ul>
     *   <li>
     *     <code>true</code> if the parameter array contains a single instance of either <code>java.io.File</code>,
     *     <code>String</code> or {@link dev.barebones.commander.commons.file.protocol.local.LocalFile} and that instance describes the
