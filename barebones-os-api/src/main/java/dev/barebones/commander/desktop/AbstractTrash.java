 ...
 * Use {@link dev.barebones.commander.core.desktop.DesktopManager#getTrash()} to retrieve an instance of a trash implementation
 * that can be used on the current platform.<br>
...
public abstract class AbstractTrash {
     ...
     * a call to {@link #moveToTrash(dev.barebones.commander.commons.file.AbstractFile)} will necessarily succeed, but it should at least ensure that basic
     ...
     * @param showErrorDialog Runnable that invokes an error dialog for unsuccessful attempt
     * @return true if the file could successfully be moved to the trash
     */
    public abstract boolean moveToTrash(AbstractFile file, Runnable showErrorDialog);
