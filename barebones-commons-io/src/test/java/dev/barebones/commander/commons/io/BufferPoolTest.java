...
public class BufferPoolTest {
     ...
     *
     * <p>This method invokes {@link #testBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory)} with a
    ...
    /**
     * Returns the length of the given buffer, as defined by {@link dev.barebones.commander.commons.io.BufferPool.BufferContainer#getLength()}.
     *
    ...
    /**
     * Returns the size in bytes of the given buffer, as defined by {@link dev.barebones.commander.commons.io.BufferPool.BufferContainer#getSize()}.
     *
