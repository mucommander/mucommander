 ...
 * @see dev.barebones.commander.commons.io.StreamUtils
 */
public class BufferPool {
     ...
     *
     * <p>This method is a shorthand for {@link #getBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory,int)} called
     * with a {@link dev.barebones.commander.commons.io.BufferPool.ByteArrayFactory} instance.</p>.
     *
     ...
     *
     * <p>This method is a shorthand for {@link #getBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory,int)} called
     * with a {@link dev.barebones.commander.commons.io.BufferPool.CharArrayFactory} instance.</p>.
     *
     ...
     *
     * <p>This method is a shorthand for {@link #getBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory,int)} called
     * with a {@link dev.barebones.commander.commons.io.BufferPool.ByteBufferFactory} instance.</p>.
     ...
     *
     * <p>This method is a shorthand for {@link #getBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory,int)} called
     * with a {@link dev.barebones.commander.commons.io.BufferPool.CharBufferFactory} instance.</p>.
    ...
    /**
     * Convenience method that has the same effect as calling {@link #getBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory, int)}
    ...
    /**
     * Makes the given buffer available for further calls to {@link #getBuffer(dev.barebones.commander.commons.io.BufferPool.BufferFactory,int)} with the same buffer
     * size and factory.
     * Returns <code>true</code> if the buffer was added to the pool, <code>false</code> if the buffer was already in 
