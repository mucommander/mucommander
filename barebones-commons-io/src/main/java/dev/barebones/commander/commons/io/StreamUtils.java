...
public class StreamUtils {
     ...
     *
     * <p>Copy progress can optionally be monitored by supplying a {@link dev.barebones.commander.commons.io.CounterInputStream} and/or
     * {@link dev.barebones.commander.commons.io.CounterOutputStream}.</p>
     *
     * @param in the InputStream to read from
     * @param out the OutputStream to write to
    ...
    /**
     * Copies a chunk of data from the given {@link dev.barebones.commander.commons.io.RandomAccessInputStream} to the specified
     * {@link dev.barebones.commander.commons.io.RandomAccessOutputStream}.
     *
     * @param rais the source stream
     * @param raos the destination stream
     * @param srcOffset offset to the beginning of the chunk in the source stream
