...
import dev.barebones.commander.commons.file.filter.ChainedFileFilter;
...
public class CommandManager implements CommandBuilder {
     ...
     * in the {@link dev.barebones.commander.conf.PlatformManager#getPreferencesFolder() preferences} folder.
     * </p>
