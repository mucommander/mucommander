...
package dev.barebones.commander.command;
 ...
 * </p>
 * <p>
 * A command's executable tokens are typically meant to be used with {@link dev.barebones.commander.process.ProcessRunner#execute(String[],AbstractFile)}
 * in order to generate instances of {@link dev.barebones.commander.process.AbstractProcess}.
 * </p>
 * @author Nicolas Rinaudo
 * @see    CommandManager
 * @see    dev.barebones.commander.process.ProcessRunner
