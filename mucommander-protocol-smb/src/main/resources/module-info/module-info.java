...
module org.mucommander.protocol.smb {
    ...
    exports com.mucommander.commons.file.protocol.smb;

    // Provide protocol services
    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.smb.SmbProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.smb.SmbProtocolPanelProvider;
}
