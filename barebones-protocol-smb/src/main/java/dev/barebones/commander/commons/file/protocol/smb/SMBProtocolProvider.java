...
/**
 * This class is the provider for the SMB filesystem implemented by {@link dev.barebones.commander.commons.file.protocol.smb.SMBFile}.
 *
 * @author Nicolas Rinaudo, Maxence Bernard
 * @see dev.barebones.commander.commons.file.protocol.smb.SMBFile
 */
