...
module org.mucommander.protocol.onedrive {
    requires org.slf4j;
    ...
    provides com.mucommander.commons.file.module.FileProtocolService
        with com.mucommander.commons.file.protocol.onedrive.OnedriveProtocolServiceProvider;

    provides com.mucommander.protocol.ui.ProtocolPanelProvider
        with com.mucommander.commons.file.protocol.onedrive.OnedriveProtocolPanelProvider;
}
