...
public final class Activator {
    ...
    public static void register() {
        FileProtocolServiceTracker.register(new FileProtocolService() {
            ...
            @Override public ProtocolProvider getProtocolProvider() { return new S3ProtocolProvider(); }
            @Override public SchemeHandler getSchemeHandler() {
                return new DefaultSchemeHandler(new DefaultSchemeParser(true), 443, "/",
        ...
        ProtocolPanelRegistry.register(new ProtocolPanelProvider() {
            ...
            @Override public int priority() { return 3000; }
        });
    }
}
