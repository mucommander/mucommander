...
/**
 * JPMS service provider for macOS operating system support (Java 8 version).
 *
 * @author Arik Hadas
 */
public class MacOSJava8OperatingSystemServiceProvider implements OperatingSystemService {
