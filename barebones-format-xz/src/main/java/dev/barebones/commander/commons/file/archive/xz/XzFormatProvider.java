...
package dev.barebones.commander.commons.file.archive.xz;
...
/**
 * This class is the provider for the 'Xz' archive format implemented by {@link XzArchiveFile}.
 *
 * @see dev.barebones.commander.commons.file.archive.xz.XzArchiveFile
 * @author Giorgos Retsinas
 */
public class XzFormatProvider implements ArchiveFormatProvider {

    /** extensions of archive filenames */
    public static final String[] EXTENSIONS = new String[] {".xz", ".txz", ".tar.xz"};

    @Override
    public AbstractArchiveFile getFile(AbstractFile file) throws IOException {
        return new XzArchiveFile(file);
    }
