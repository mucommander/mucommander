...
/**
 * This class is a JUnit test case for {@link dev.barebones.commander.commons.file.util.PathUtils}.
 *
 * @author Maxence Bernard
 * @see dev.barebones.commander.commons.file.util.PathUtils
 */
public class PathUtilsTest {
    ...
    /**
     * Tests {@link dev.barebones.commander.commons.file.util.PathUtils} by throwing at it a bunch of sample paths corresponding to all
     * possible situations.
     *
    ...
    /**
     * Asserts that the <code>ResolvedDestination</code> returned by {@link PathUtils#resolveDestination(String, dev.barebones.commander.commons.file.AbstractFile)}
