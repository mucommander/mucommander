...
import dev.barebones.commander.commons.file.archive.zip.ZipFormatProvider;
import dev.barebones.commander.commons.file.util.PathUtilsTest;
...
import dev.barebones.commander.commons.io.ChecksumOutputStream;
...
import dev.barebones.commander.commons.io.RandomGeneratorInputStream;
...
public abstract class AbstractFileTest {
    ...
    /**
     * Tests the <code>java.net.URL</code> returned by {@link dev.barebones.commander.commons.file.AbstractFile#getJavaNetURL()}
    ...
    /**
     * Tests {@link dev.barebones.commander.commons.file.AbstractFile#exists()} in various situations.
     *
     * @throws IOException should not happen
     */
    @Test
    ...
    /**
     * Tests {@link dev.barebones.commander.commons.file.util.PathUtils#resolveDestination(String, AbstractFile)} by calling
