 ...
 * {@link dev.barebones.commander.commons.file.filter.ChainedFileFilter}.</p>
 *
...
public class AttributeFileFilter extends AbstractFileFilter {
	...
	public enum FileAttribute {
		/** Tests if the file is a {@link dev.barebones.commander.commons.file.AbstractFile#isDirectory() directory}. */
		DIRECTORY,
		/** Tests if the file is a regular file, i.e. not a directory. This is equivalent to negating {@link #DIRECTORY}. */
		FILE,
		/** Tests if the file is {@link dev.barebones.commander.commons.file.AbstractFile#isBrowsable() browsable}. */
		BROWSABLE,
		/** Tests if the file is an {@link dev.barebones.commander.commons.file.AbstractFile#isArchive() archive}. */
		ARCHIVE,
		/** Tests if the file is a {@link dev.barebones.commander.commons.file.AbstractFile#isSymlink() symlink}. */
		SYMLINK,
		/** Tests if the file is {@link dev.barebones.commander.commons.file.AbstractFile#isHidden() hidden}. */
		HIDDEN,
		/** Tests if the file is a {@link dev.barebones.commander.commons.file.AbstractFile#isRoot() root folder}. */
		ROOT,
		/** Tests if the file is a {@link dev.barebones.commander.commons.file.AbstractFile#isSystem() system file}. */
		SYSTEM;
	}
