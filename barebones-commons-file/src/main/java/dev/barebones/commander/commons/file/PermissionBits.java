 ...
 * in {@link dev.barebones.commander.commons.file.PermissionType} and {@link dev.barebones.commander.commons.file.PermissionAccess} respectively.
 ...
 *   <ul>
 *     <li>{@link dev.barebones.commander.commons.file.GroupedPermissionBits} (full implementation): implements this interface using a
 * given permission int.</li>
 *     <li>{@link dev.barebones.commander.commons.file.IndividualPermissionBits} (partial implementation): implements the
 * <code>getIntValue()</code> method by relying on <code>getBitValue()</code> and querying it sequentially for every
 * permission bit.</li>
 *   </ul>
 * </p>
 *
 * @see dev.barebones.commander.commons.file.GroupedPermissionBits
 * @see dev.barebones.commander.commons.file.IndividualPermissionBits
...
public interface PermissionBits {
     ...
     * bits can be isolated by comparing them against the values defined in {@link dev.barebones.commander.commons.file.PermissionType}
     * and {@link dev.barebones.commander.commons.file.PermissionAccess}.
     *
     ...
     * if it isn't.
     *
     * @param access one of the values defined in {@link dev.barebones.commander.commons.file.PermissionAccess}
