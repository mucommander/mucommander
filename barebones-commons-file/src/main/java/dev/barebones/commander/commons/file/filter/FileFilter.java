 ...
 * @see FilenameFilter
 * @see dev.barebones.commander.commons.file.AbstractFile#ls(FileFilter)
...
public interface FileFilter {
    ...
    /**
     * Sets the mode in which {@link #match(dev.barebones.commander.commons.file.AbstractFile)} operates. If <code>true</code>, this
     * filter will operate in inverted mode: files that would be accepted by {@link #match(dev.barebones.commander.commons.file.AbstractFile)}
     * in normal (non-inverted) mode will be rejected, and vice-versa.<br>
     * The inverted mode has no effect on the values returned by {@link #accept(dev.barebones.commander.commons.file.AbstractFile)} and
     * {@link #reject(dev.barebones.commander.commons.file.AbstractFile)}.
     *
     ...
     * mode:
     * <ul>
     *  <li>if this filter currently operates in normal (non-inverted) mode, this method will return the value of {@link #accept(dev.barebones.commander.commons.file.AbstractFile)}</li>
     *  <li>if this filter currently operates in inverted mode, this method will return the value of {@link #reject(dev.barebones.commander.commons.file.AbstractFile)}</li>
     * </ul>
     *
     ...
     *
     * @param files files to be tested against {@link #match(dev.barebones.commander.commons.file.AbstractFile)}
