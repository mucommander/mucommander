...
package dev.barebones.commander.commons.file.icon;
...
public interface CacheableFileIconProvider extends FileIconProvider {
     ...
     *
     * <p>This method is called by {@link CachedFileIconProvider#getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
     * each time an icon is requested. If <code>true</code> is returned, the icon cache will be looked up with
     * {@link #lookupCache(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)} and if the cache did not return
     * an icon, the icon will be be added to the cache with {@link #addToCache(dev.barebones.commander.commons.file.AbstractFile, javax.swing.Icon, java.awt.Dimension)}.
     * <br/>
     * On the other hand, if <code>false</code> is returned, {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
    ...
    /**
     * This method is called by {@link CachedFileIconProvider#getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
     ...
     * <br/>
     * On the other hand, if <code>null</code> is returned, the icon will be fetched using {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
     * followed by a call to {@link #addToCache(dev.barebones.commander.commons.file.AbstractFile, javax.swing.Icon,java.awt.Dimension)}
     * to add the freshly-retrieved icon to the cache.
     *
     * <p>This method is called only if the prior call to {@link #isCacheable(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
    ...
    /**
     * This method is called by {@link CachedFileIconProvider#getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
     * to give implementations a chance to cache an icon fetched with {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}
     * and have it returned later by {@link #lookupCache(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}.
     * <br/>
