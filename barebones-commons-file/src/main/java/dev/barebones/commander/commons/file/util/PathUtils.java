...
public class PathUtils {
    ...
    /**
     * This class represents a destination entered by the user and resolved by {@link PathUtils#resolveDestination(String, dev.barebones.commander.commons.file.AbstractFile)}
     * into an <code>AbstractFile</code> and a destination type.
     *
     * @see PathUtils#resolveDestination(String, dev.barebones.commander.commons.file.AbstractFile)
     */
     ...
     * {@link dev.barebones.commander.commons.file.SchemeParser} to canonize.
     * </p>
     * <p>
