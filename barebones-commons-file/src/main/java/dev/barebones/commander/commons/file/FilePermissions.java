...
/**
 * FilePermissions is an interface that represents the permissions of an {@link dev.barebones.commander.commons.file.AbstractFile}.
 * The actual permission values can be retrieved by the methods inherited from the
 * {@link dev.barebones.commander.commons.file.PermissionBits} interface. The permissions mask returned by {@link #getMask()} allows
 ...
 *
 * @see dev.barebones.commander.commons.file.AbstractFile#getPermissions()
