...
/**
 * This class is a simple implementation of the {@link dev.barebones.commander.commons.file.FileAttributes} interface, where all
...
public class SimpleFileAttributes implements MutableFileAttributes {
     ...
     * Note that the path attribute is set to the file's {@link dev.barebones.commander.commons.file.AbstractFile#getAbsolutePath() absolute path}.
     *
