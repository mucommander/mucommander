...
/**
 * GroupedPermissionBits is an implementation of {@link dev.barebones.commander.commons.file.PermissionBits} using a given UNIX-style
...
public class GroupedPermissionBits implements PermissionBits {
     ...
     * by combining (binary OR and shift) values defined in {@link dev.barebones.commander.commons.file.PermissionTypes} and
     * {@link dev.barebones.commander.commons.file.PermissionAccess}.
     *
