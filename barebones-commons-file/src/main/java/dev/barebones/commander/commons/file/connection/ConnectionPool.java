...
package dev.barebones.commander.commons.file.connection;
...
/**
 * @see dev.barebones.commander.commons.file.connection.ConnectionHandler
...
public class ConnectionPool implements Runnable {
     ...
     * active, {@link dev.barebones.commander.commons.file.connection.ConnectionHandler#keepAlive()} will not be called.
     */
