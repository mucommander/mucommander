...
import dev.barebones.commander.commons.io.ChecksumInputStream;
import dev.barebones.commander.commons.io.FileTransferError;
 ...
 *
 * @see dev.barebones.commander.commons.file.FileFactory
 * @see dev.barebones.commander.commons.file.ProxyFile
...
public abstract class AbstractFile implements FileAttributes {
     ...
     *
     * <p>Copy progress can optionally be monitored by supplying a {@link dev.barebones.commander.commons.io.CounterInputStream}.</p>
     *
     ...
     * {@link dev.barebones.commander.commons.file.PermissionType} and {@link dev.barebones.commander.commons.file.PermissionAccess}.
     *
    ...
    /**
     * Returns an icon representing this file, using the default {@link dev.barebones.commander.commons.file.icon.FileIconProvider}
     * registered in {@link FileFactory}. The specified preferred resolution will be used as a hint, but the returned
     * icon may have different dimension; see {@link dev.barebones.commander.commons.file.icon.FileIconProvider#getFileIcon(AbstractFile, java.awt.Dimension)}
     * for full details.
     ...
     * @see dev.barebones.commander.commons.file.FileFactory#getDefaultFileIconProvider()
     * @see dev.barebones.commander.commons.file.icon.FileIconProvider#getFileIcon(AbstractFile, java.awt.Dimension)
     */
     ...
     * certain permission bits, use the {@link dev.barebones.commander.commons.file.FilePermissions#getMask() permission mask} to find
