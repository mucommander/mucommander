...
/**
 * This class provides access to a static instance of the {@link dev.barebones.commander.commons.file.util.Kernel32API} interface,
...
public class Kernel32 {
    ...
    /**
     * Returns a static instance of the {@link dev.barebones.commander.commons.file.util.Kernel32API} interface, allowing to invoke
     * some Kernel32 Windows DLL functions. <code>null</code> will be returned if {@link #isAvailable()} returned
     * <code>false</code>.
     *
     * @return a static instance of the {@link dev.barebones.commander.commons.file.util.Kernel32API} interface, <code>null</code>
