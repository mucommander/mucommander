 ...
 *
 * <p>This class is useful for wrapper files, such as {@link dev.barebones.commander.commons.file.archive.AbstractArchiveFile archive files},
 ...
 * proxy method invocations, so any modifications made to {@link dev.barebones.commander.commons.file.AbstractFile} must be also
 * reflected in <code>ProxyFile</code>.
 *
 * @see dev.barebones.commander.commons.file.archive.AbstractArchiveFile
