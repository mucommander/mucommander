...
public class ResourceLoader {
     ...
     * with a trailing separator. For example, if the package <code>dev.barebones.commander.commons.file</code> is passed, the returned
     ...
     * class <code>dev.barebones.commander.commons.file.AbstractFile</code> is passed,  the returned path will be
