...
/**
 * This class provides access to a static instance of the {@link dev.barebones.commander.commons.file.util.Shell32API} interface,
...
public class Shell32 {
    ...
    /**
     * Returns a static instance of the {@link dev.barebones.commander.commons.file.util.Shell32API} interface, allowing to invoke
     * some Shell32 Windows DLL functions. <code>null</code> will be returned if {@link #isAvailable()} returned
     * <code>false</code>.
     *
     * @return a static instance of the {@link dev.barebones.commander.commons.file.util.Shell32API} interface, <code>null</code> if it
