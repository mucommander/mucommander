...
import dev.barebones.commander.commons.file.ModificationDateBasedMonitoredFile;
import dev.barebones.commander.commons.file.MonitoredFile;
import dev.barebones.commander.commons.file.ProxyFile;
 ...
 * @see dev.barebones.commander.commons.file.archive.ArchiveFormatProvider
 * @see dev.barebones.commander.commons.file.archive.ArchiveEntry
 * @see AbstractArchiveEntryFile
 * @see dev.barebones.commander.commons.file.archiver.Archiver
...
public abstract class AbstractArchiveFile extends ProxyFile {
    ...
    /**
     * Creates the entries tree, used by {@link #ls(AbstractArchiveEntryFile , dev.barebones.commander.commons.file.filter.FilenameFilter, dev.barebones.commander.commons.file.filter.FileFilter)}
     ...
     *
     * <p>
     * This method is implemented by {@link dev.barebones.commander.commons.file.archive.AbstractROArchiveFile} and
     * {@link dev.barebones.commander.commons.file.archive.AbstractRWArchiveFile} to respectively return <code>false</code> and
