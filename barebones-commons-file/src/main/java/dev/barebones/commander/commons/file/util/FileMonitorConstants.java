...
/**
 * Contains constants used by {@link dev.barebones.commander.commons.file.util.FileMonitor}.
 *
 * @author Maxence Bernard
 */
public interface FileMonitorConstants {

    /** File date attribute, as returned by {@link dev.barebones.commander.commons.file.AbstractFile#getDate()}. */
    public final static int DATE_ATTRIBUTE = 1;

    /** File size attribute, as returned by {@link dev.barebones.commander.commons.file.AbstractFile#getSize()}. */
    public final static int SIZE_ATTRIBUTE = 2;

    /** File permissions attribute, as returned by {@link dev.barebones.commander.commons.file.AbstractFile#getPermissions()}. */
    public final static int PERMISSIONS_ATTRIBUTE = 4;

    /** File 'is directory' attribute, as returned by {@link dev.barebones.commander.commons.file.AbstractFile#isDirectory()}. */
    public final static int IS_DIRECTORY_ATTRIBUTE = 8;

    /** File 'exists' attribute, as returned by {@link dev.barebones.commander.commons.file.AbstractFile#exists()}. */
