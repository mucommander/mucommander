...
package dev.barebones.commander.commons.file.icon.impl;
...
import dev.barebones.commander.commons.file.icon.CachedFileIconProvider;
import dev.barebones.commander.commons.file.icon.IconCache;
import dev.barebones.commander.commons.file.icon.LocalFileIconProvider;
...
import dev.barebones.commander.commons.io.SilenceableOutputStream;
import dev.barebones.commander.commons.runtime.OsFamily;

/**
 * Package-protected class which provides the {@link dev.barebones.commander.commons.file.icon.LocalFileIconProvider} and
 * {@link dev.barebones.commander.commons.file.icon.CacheableFileIconProvider} implementations to {@link SwingFileIconProvider}.
 *
