 ...
 *
 * <p>The <code>chmod</code> command is available only under {@link dev.barebones.commander.commons.runtime.OsFamily#isUnixBased() UNIX-based}
 * systems -- a call to any of this class' methods under other OS will likely fail.</p>
 *
 * @author Maxence Bernard
 * @see dev.barebones.commander.commons.file.FilePermissions
 */
public class Chmod {
