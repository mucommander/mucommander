 ...
 *
 * <p>This class implements {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)} and passes on
 * requests for local file icons to {@link #getLocalFileIcon(dev.barebones.commander.commons.file.protocol.local.LocalFile, dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}.
 ...
 * to {@link #getLocalFileIcon(dev.barebones.commander.commons.file.protocol.local.LocalFile, dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)}.</p>
 *
...
public abstract class LocalFileIconProvider implements FileIconProvider {
     ...
     * called by {@link #getFileIcon(dev.barebones.commander.commons.file.AbstractFile, java.awt.Dimension)} with a {@link LocalFile}
