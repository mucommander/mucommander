...
import dev.barebones.commander.commons.file.protocol.local.LocalProtocolProvider;
import dev.barebones.commander.commons.file.protocol.search.SearchFile;
import dev.barebones.commander.commons.file.protocol.search.SearchProtocolProvider;
 ...
 * <h3>Protocols</h3>
 * <p>
 * In order to allow the <code>dev.barebones.commander.commons.file</code> API to access new file protocols, developers must create
 ...
 * <p>
 * In order to allow the <code>dev.barebones.commander.commons.file</code> API to access new archive formats, developers must create
...
public class FileFactory {
    ...
    /**
     * Returns the default {@link dev.barebones.commander.commons.file.icon.FileIconProvider} instance. The default provider class
     * (before {@link #setDefaultFileIconProvider(dev.barebones.commander.commons.file.icon.FileIconProvider)} is called) is
     * platform-dependent and as such may vary across platforms.
     *
     * <p>It is noteworthy that the provider returned by this method is used by {@link dev.barebones.commander.commons.file.AbstractFile#getIcon()}
    ...
    /**
     * Sets the default {@link dev.barebones.commander.commons.file.icon.FileIconProvider} implementation.
     *
     * <p>It is noteworthy that the provider returned by this method is used by {@link dev.barebones.commander.commons.file.AbstractFile#getIcon()}
      * to create and return the icon.</p>
      *
