...
import com.mucommander.translator.TranslationServiceProvider;
...
public class SizeFormatTest {
    ...
    /**
     * Initialize the Translator before running tests.
     * SizeFormat uses localized strings from the Translator.
     */
    @BeforeClass
