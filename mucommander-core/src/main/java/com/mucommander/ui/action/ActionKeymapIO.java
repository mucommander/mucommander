...
public abstract class ActionKeymapIO extends DefaultHandler {
     ...
     * file is {@link #DEFAULT_ACTIONS_FILE_NAME} within the preferences folder.
     * <p>
     * This is a convenience method and is strictly equivalent to calling
     * <code>setActionsFile(FileFactory.getFile(file))</code>.
     * </p>
     * 
     * @param path
     *            path to the actions file
     * @throws FileNotFoundException
     *             if <code>file</code> is not accessible.
     */
     ...
     * <p>
     * This is a convenience method and is strictly equivalent to calling
     * <code>setActionsFile(FileFactory.getFile(file.getAbsolutePath()))</code>.
     * </p>
     * 
     * @param file
     *            path to the actions file
     ...
     * @throws IOException
     *             if an error occurred while locating the default actions file.
     */
    ...
    /**
     * Loads the action files: loads the one contained in the JAR file first, and then the user's one. This means any
     * new action in the JAR action keymap (when a new version is released) will have the default keyboard mapping, but
     * the keyboard mappings customized by the user in the user's action keymap will override the ones from the JAR
     * action keymap.
     *
     * <p>
