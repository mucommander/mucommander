    ...
    public int Extract(int[] indices, int numItems,
      ...
      UInt32 fileIndex = ref.ItemIndex;
         ...
         */
                ...
                if (folderIndex == com.mucommander.commons.file.archive.sevenzip.provider.SevenZip.Archive.SevenZip.InArchive.kNumNoIndex) {
                    extractFolderInfoVector.add(new ExtractFolderInfo(
                            ...
                            // volumeIndex,
                            // #endif
                            fileIndex, com.mucommander.commons.file.archive.sevenzip.provider.SevenZip.Archive.SevenZip.InArchive.kNumNoIndex));
                    continue;
                }
         ...
         */
            ...
            #endif
             */
                            com.mucommander.commons.file.archive.sevenzip.provider.SevenZip.Archive.SevenZip.InArchive.kNumNoIndex, folderIndex));
