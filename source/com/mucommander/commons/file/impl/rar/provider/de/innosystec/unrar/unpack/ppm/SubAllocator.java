...
public class SubAllocator
{
	...
	public boolean startSubAllocator(int SASize) throws Exception
	{
		int t = SASize << 20;
...
//        assert (realAllocSize - tempMemBlockPos == RarMemBlock.size) : realAllocSize + " " + tempMemBlockPos + " " + RarMemBlock.size;
		if (realAllocSize - tempMemBlockPos != RarMemBlock.size)
			System.err.println((realAllocSize - tempMemBlockPos) + " != " + RarMemBlock.size + " at SubAllocator#startSubAllocator");
