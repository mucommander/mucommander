...
//        assert (mem != null);
		if (mem == null)
			System.err.println("mem is null at Pointer#getAddress");
		return pos;
	}
...
//        assert (mem != null);
		if (mem == null)
			System.err.println("mem is null at Pointer#setAddress");
//        assert (pos >= 0) && (pos < mem.length) : pos;
		if (!((pos >= 0) && (pos < mem.length)))
			System.err.println("pos == " + pos + " at Poniter#setAddress");
        this.pos = pos;
    }
}
