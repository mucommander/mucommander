 ...
 * "@":  "&#064;" 
 */
package com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack;

import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.exception.RarException;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.decode.Compress;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.ppm.BlockTypes;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.ppm.ModelPPM;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.ppm.SubAllocator;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.vm.BitInput;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.vm.RarVM;
import com.mucommander.commons.file.impl.rar.provider.de.innosystec.unrar.unpack.vm.VMPreparedProgram;
...
public final class Unpack extends Unpack20
{
	...
	public void doUnpack(int method, boolean solid) throws Exception
	{
	...
	private void unpack29(boolean solid) throws Exception
	{
	...
	private boolean readEndOfBlock() throws Exception
	{
	...
	private boolean readTables() throws Exception
	{
		...
		if ((bitField & 0x8000) != 0) {
			...
			return ((ppm/* = new ModelPPM()*/		).decodeInit(this, ppmEscChar));// arik ppm.decodeInit(this, ppmEscChar));
		}
	...
	private boolean addVMCode(int firstByte, List vmCode, int length)
	{
		...
		if (NewFilter) // new filter code, never used before since VM reset
		{
			...
			oldFilterLengths.add(Integer.valueOf(0));
		...
		oldFilterLengths.set(FiltPos, Integer.valueOf(StackFilter.getBlockLength()));
