...
public class ResourceLoaderTest extends TestCase {
    ...
    public void testRelativeClassPath() {
        assertEquals("com/mucommander/commons/file/util/ResourceLoaderTest.class", ResourceLoader.getRelativeClassPath(getClass()));
    }
    ...
    public void testRelativePackagePath() {
        ...
        assertEquals("com/mucommander/commons/file/util", ResourceLoader.getRelativePackagePath(getThisPackage()));
    }
