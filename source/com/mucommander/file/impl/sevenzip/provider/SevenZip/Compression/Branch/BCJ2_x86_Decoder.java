...
package com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.Branch;
...
import com.mucommander.file.impl.sevenzip.provider.SevenZip.Common.InBuffer;
...
public class BCJ2_x86_Decoder implements ICompressCoder2 {
    ...
    com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder _statusE8Decoder[] = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder[256];
    com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder _statusE9Decoder = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder(kNumMoveBits);
    com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder _statusJccDecoder = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder(kNumMoveBits);
    
    OutWindow _outStream = new OutWindow();
    com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder _rangeDecoder = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder();
    ...
    int CodeReal(
        ...
        for (int i = 0; i < 256; i++) {
            _statusE8Decoder[i] = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.BitDecoder(kNumMoveBits);
    ...
    public int Code(
            RecordVector inStreams, // ISequentialInStream **inStreams,
            Object useless_inSizes, // const UInt64 ** /* inSizes */,
            int numInStreams,
            RecordVector outStreams, // ISequentialOutStream **outStreams
