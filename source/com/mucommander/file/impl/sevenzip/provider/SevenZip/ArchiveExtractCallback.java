...
public class ArchiveExtractCallback implements IArchiveExtractCallback // , ICryptoGetTextPassword,
{
    ...
    protected com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.IInArchive _archiveHandler;  // IInArchive
    protected String _filePath;       // name inside arcvhive
    ...
    public void Init(com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.IInArchive archiveHandler) {
        NumErrors = 0;
