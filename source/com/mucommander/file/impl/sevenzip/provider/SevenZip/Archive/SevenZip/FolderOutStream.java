...
import com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.Common.OutStreamWithCRC;
...
class FolderOutStream extends java.io.OutputStream {
    ...
    int OpenFile() throws java.io.IOException {
        ...
        if (askMode == IInArchive.NExtract_NAskMode_kExtract &&
                (realOutStream == null)) {
            FileItem fileInfo = (FileItem) _archiveDatabase.Files.get(index);
