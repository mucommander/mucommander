...
public class Handler implements com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.IInArchive {
    ...
    public int Extract(int [] indices, int numItems,
        ...
        ObjectVector extractFolderInfoVector = new ObjectVector();
      ...
      UInt32 fileIndex = ref.ItemIndex;
         ...
         */
                ...
                if (folderIndex == com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.SevenZip.InArchive.kNumNoIndex) {
                    extractFolderInfoVector.add( new ExtractFolderInfo(
                            // #ifdef _7Z_VOL
                            // volumeIndex,
                            // #endif
                            fileIndex, com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.SevenZip.InArchive.kNumNoIndex));
                    continue;
                }
                if (extractFolderInfoVector.isEmpty() ||
                        folderIndex != ((ExtractFolderInfo) extractFolderInfoVector.Back()).FolderIndex
        /*
        #ifdef _7Z_VOL
         ...
         */
            ...
            #endif
             */
                            com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.SevenZip.InArchive.kNumNoIndex, folderIndex));
 ...
 */
    ...
    public SevenZipEntry getEntry(int index) {
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Archive.SevenZip.FileItem item = (FileItem) _database.Files.get(index);
        int index2 = index;
