...
public class LzmaBench
{
	...
	{
		public com.mucommander.file.impl.sevenzip.provider.Common.CRC CRC = new com.mucommander.file.impl.sevenzip.provider.Common.CRC();
	...
	static public int LzmaBenchmark(int numIterations, int dictionarySize) throws Exception
	{
		...
		com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.LZMA.Encoder encoder = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.LZMA.Encoder();
		com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.LZMA.Decoder decoder = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.LZMA.Decoder();
		...
		rg.Set(kBufferSize);
		rg.Generate();
		com.mucommander.file.impl.sevenzip.provider.Common.CRC crc = new com.mucommander.file.impl.sevenzip.provider.Common.CRC();
		crc.Init();
