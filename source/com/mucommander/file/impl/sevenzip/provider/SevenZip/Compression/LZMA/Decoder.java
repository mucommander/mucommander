...
public class Decoder
        ...
        implements com.mucommander.file.impl.sevenzip.provider.SevenZip.ICompressCoder , com.mucommander.file.impl.sevenzip.provider.SevenZip.ICompressSetDecoderProperties2 ,
        com.mucommander.file.impl.sevenzip.provider.SevenZip.ICompressGetInStreamProcessedSize,
        // #ifdef _ST_MODE
        com.mucommander.file.impl.sevenzip.provider.SevenZip.ICompressSetInStream,
        com.mucommander.file.impl.sevenzip.provider.SevenZip.ICompressSetOutStreamSize
        // #endif
        
{
    class LenDecoder {
        ...
        public void Init() {
            com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_Choice);
        ...
        public int Decode(com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        class Decoder2 {
            ...
            public void Init() {
                com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_Decoders);
            }
            
            public byte DecodeNormal(com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do
            ...
            public byte DecodeWithMatchByte(com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do
                {
    ...
    com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder m_RangeDecoder = new com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder();
    ...
    public int ReleaseInStream() throws IOException {
        ...
        return com.mucommander.file.impl.sevenzip.provider.SevenZip.HRESULT.S_OK;
    }
    ...
    public int SetOutStreamSize(long outSize /* const UInt64 *outSize*/ ) {
        _outSizeDefined = (outSize != com.mucommander.file.impl.sevenzip.provider.SevenZip.ICompressSetOutStreamSize.INVALID_OUTSIZE);
        if (_outSizeDefined)
            _outSize = outSize;
    ...
    void Init() throws IOException {
        ...
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsMatchDecoders);
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepDecoders);
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG0Decoders);
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG1Decoders);
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG2Decoders);
        com.mucommander.file.impl.sevenzip.provider.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_PosDecoders);
