...
/**
 * A {@link com.mucommander.test.SingleConditionalTestSuite} that executes {@link com.mucommander.file.impl.sftp.SFTPFileTestCase} only if
 * the {@link #ENABLED_PROPERTY} system property is set to <code>"true"</code>.
 *
 * @author Maxence Bernard
 */
public class SFTPFileTest extends SingleConditionalTestSuite {
