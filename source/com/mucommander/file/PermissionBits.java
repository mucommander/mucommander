 ...
 * in {@link com.mucommander.file.PermissionTypes} and {@link com.mucommander.file.PermissionAccesses} respectively.
 ...
 *   <ul>
 *     <li>{@link com.mucommander.file.GroupedPermissionBits} (full implementation): implements this interface using a
 * given permission int.</li>
 *     <li>{@link com.mucommander.file.IndividualPermissionBits} (partial implementation): implements the
 * <code>getIntValue()</code> method by relying on <code>getBitValue()</code> and querying it sequentially for every
 * permission bit.</li>
 *   </ul>
 * </p>
 *
 * @see com.mucommander.file.GroupedPermissionBits
 * @see com.mucommander.file.IndividualPermissionBits
...
public interface PermissionBits {
     ...
     * bits can be isolated by comparing them against the values defined in {@link com.mucommander.file.PermissionTypes}
     * and {@link com.mucommander.file.PermissionAccesses}.
     *
     ...
     * if it isn't.
     *
     * @param access one of the values defined in {@link com.mucommander.file.PermissionAccesses}
     * @param type one of the values defined in {@link com.mucommander.file.PermissionTypes}
