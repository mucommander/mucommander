 ...
 * Invoked from multi-rename dialog.
 *  
 * @author Mariusz Jakubowski
 *
 */
public class MultiRenameSelectRange extends FocusDialog implements ActionListener {
    ...
    public MultiRenameSelectRange(Dialog owner, String filename) {
        super(owner, Translator.get("multi_rename_dialog.title"), owner);
