...
public abstract class FileTablePopup extends JPopupMenu implements FocusListener {
	protected HeaderItem headerMenuItem;
	protected FolderPanel folderPanel;
	
	protected FileTablePopup(String header, FolderPanel panel) {
		super();
		
		folderPanel = panel;
		setBorder(new PopupsBorder());
		add(headerMenuItem = new HeaderItem(header));		
	...
	protected FolderPanel getPanel() {
		return folderPanel;
	}	
